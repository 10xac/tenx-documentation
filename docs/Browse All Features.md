...
_Below, you’ll find concise descriptions of each project’s purpose and capabilities, so you can quickly understand how they work together to support trainee success._
...
AI platform that matches trainees to jobs and builds tailored CVs.
...
Automated pipeline that transforms structured data into professional CVs and certificates.

Key Features

- Customizable CV & cover-letter templates with section-order API
- Branded certificate generation
- LLM-driven JSON→PDF conversion pipeline
- Multi-source data extraction and conflict resolution
- Tiered output settings: Basic, Standard, Optimized

---

## **Intelligent Forms**

Smart form engine to collect and validate trainee data with AI assistance.

Key Features

- Semantic & AI-driven field validation
- Contextual auto-suggestions and mock-data generation
- Friendly error guidance with “remove suggestion” option
- Flexible template schema supporting dynamic form structures
...
Scalable, cost-optimized hosting and deployment backbone.

Key Features

- Services on three Hostinger VPS instances with secure AWS RDS connectivity
- Fully automated CI/CD pipelines for rapid deployments
- Cloud-cost optimization strategies to reduce overhead

---

## **Parrot (Interview Simulator)**
...
Automated task creator for skill-tagged training challenges.

Key Features

- Generates tasks at Basic, Intermediate, and Advanced levels
- Maps skills to challenge templates for targeted practice
